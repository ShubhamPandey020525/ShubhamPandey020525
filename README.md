  ...
  <table width="100%">
    <tr>
      ...
      <td width="20%" align="right">
        <img src="img/chamber_card.gif" width="120" style="border-radius: 50%; border: 2px solid #ff4655;" />
      </td>
    </tr>
  </table>
</div>
...
- **AI/ML Mentor** | Bennett University
- **Collaborator** | Team-based AI Projects (RAG, Agentic workflows)

---

### 🎓 Education
- **Bennett University, Greater Noida** | B.Tech in CSE (AI) 
  - *2023 – 2027* | Current SGPA: **8.36** | CGPA: **7.9/10**
- **Shiksha Bharati School** | Class XII & X (CBSE)
  - XII: **84%** | X: **91%**
...
<div align="center">
  <blockquote>
    <h3>"They think they are safe. How adorable."</h3>
  </blockquote>
  
  <p><i>Building the future with precision and class.</i></p>
